        ...
        <div className="flex flex-col md:flex-row items-center lg:h-[80vh] justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0 flex flex-col space-y-4 px-6 lg:px-0 lg:mt-0 mt-10">
            ...
            <p className="mb-4 text-gray tracking-wider leading-loose cursor-pointer">
              ...
              creating intuitive and scalable applications. With proficiency in
              the MERN stack (MongoDB, Express.js, React, and Node.js), I have
              built Projects such as a full-stack food ordering website , a job
              portal, and even a LinkedIn clone. My projects demonstrate my
...
>
  <button
    className="border border-gray-400 bg-white/80 text-gray-600 px-4 py-2 w-max rounded-md mt-2 
      transition-all duration-300 ease-in-out shadow-md hover:bg-gray-200 hover:border-blue-500 
      hover:text-blue-600 active:scale-95 cursor-pointer"
  >
    Resume
  </button>
</a>
          ...
          >
            {/* Card with floating, tilt, scaling, and bounce effect */}
            <div
              ...
              style={{
                transform: `perspective(1000px) translateY(10px) rotateX(${
                  move.y * 20
                }deg) rotateY(${move.x * 20}deg) scale(1.05)`,
                boxShadow: isMoving
                  ? `0 25px 50px rgba(0, 0, 0, 0.3)`
                  : `0 15px 30px rgba(0, 0, 0, 0.2)`,
                transition:
                  "transform 200ms ease-out, box-shadow 300ms ease-out",
              }}
            >
              {/* Top part */}
              <div className=" mt-4 flex justify-center items-center ">
                {/* Larger Circle for profile picture with red border and shadow */}
              ...
              <div className="mt-2 flex flex-col items-center justify-center px-4">
                {/* New Rectangle with Gmail Icon and Email */}
                ...
                <div className="w-full flex items-center justify-between bg-white rounded-md p-2 mb-4 border-4 border-red-50 shadow-xl ">
                  {/* Gmail Icon */}
                  <a
                    href="mailto:adityamedipelly3@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                ...
                <div className="mt-2 flex space-x-8">
                  {/* Twitter Icon */}
                  <a
                    href="https://github.com/adityAmedipelly"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img src={git} alt="Twitter" className="w-8 h-8" />
                  </a>
                  {/* LinkedIn Icon */}
                  <a
                    href="https://www.linkedin.com/in/aditya-yadav-b306aa334/"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  {/* GitHub Icon */}
                  <a
                    href="https://x.com/AdityaMedipelly"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                  ...
                  {/* Email Icon */}
                  <a
                    href="https://wa.me/8106631412"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <img src={whatsapp} alt="Email" className="w-8 h-8" />
                  </a>
                </div>
              </div>
            </div>
