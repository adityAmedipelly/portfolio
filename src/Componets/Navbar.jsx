...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-4 z-50 mx-auto w-full">
      {/* Content wrapper with background */}
      <div className="max-w-screen-sm mx-auto rounded-2xl border border-gray-300 bg-white/80 backdrop-blur-lg px-4 py-5 shadow-lg">
